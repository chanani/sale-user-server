...
public class KakaoUserInfoResponseDto {
    ...
    public void formatPhoneNumber() {
        this.kakaoAccount.phoneNumber = "0".concat(kakaoAccount.phoneNumber.substring(4, kakaoAccount.phoneNumber.length()));
    }
    ...
    public void updatePhoneNumber(String phoneNumber) {
        this.kakaoAccount.phoneNumber = phoneNumber;
    }

    /**
     * 생년월일 형식 변경
     */
    public void formatBirth(){
        String birthDay = this.kakaoAccount.birthDay;
        String formattedBirthDay = birthDay.substring(0, 2) + "-" + birthDay.substring(2, 4);
        this.kakaoAccount.userBirth = this.kakaoAccount.birthYear + "-" + formattedBirthDay;
    }
    ...
    public void formatGender(){
        String gender = this.kakaoAccount.gender;
        if(gender.equals("male")){
            this.kakaoAccount.gender = "M";
        } else {
            this.kakaoAccount.gender = "F";
        }
    }
}
